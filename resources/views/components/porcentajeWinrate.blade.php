<div {{ $attributes->merge(['class'=>"w-[100%] h-[165px] border-primary border-solid border-[1px] rounded-[10px] flex flex-col bg-transparent text-white"]) }}>
                ...
                <form class="flex justify-between items-center w-[50%]" method="POST">
                    ...
                    <div class="relative w-full flex items-end">
                        <input type="search" id="default-search"
                            class="w-full h-[40px] text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 items-end focus:ring-blue-500 focus:border-blue-500 placeholder:text-text_dark placeholder:font-bold placeholder:text-[2xl]"
                            placeholder="Busca un campeón" required />
                        <button type="submit"
                            class="text-white absolute right-0 top-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600">
