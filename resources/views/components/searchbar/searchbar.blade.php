<form action="{{ route('search.summoner') }}" class="flex justify-between items-center w-full gap-8" method="POST">
    ...
    <div class="relative w-full flex">
        ...
        <button type="submit"
            class="text-white absolute right-0 top-0 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600">
