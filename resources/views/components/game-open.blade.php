                            ...
                            <div class="flex justify-between w-full">
                                <div class="flex h-[35px] w-fit gap-2">
                                    <div class="flex gap-2">
                                        <img src="https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-icons/{{$player["championId"]}}.png" alt="" class="h-full rounded-lg">
